...
const routes: Routes = [
  ...
  { path: 'profile/:id/qualifications', component: ProfileComponent, canActivate: [AuthGuard]},
  { path: 'profile/:id/services', component: ProfileComponent, canActivate: [AuthGuard]},
  { path: 'profile/:id/reviews', component: ProfileComponent, canActivate: [AuthGuard]},
